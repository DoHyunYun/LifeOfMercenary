...
UDataTableManager::UDataTableManager() : m_armorDataTable(nullptr), m_weaponDataTable(nullptr), m_questDataTable(nullptr), m_monsterDataTable(nullptr)
{
	...
	m_monsterDataTable = ULoMFunctions::GetDataTableFromString(TEXT("DataTable'/Game/DataTables/DT_Monster.DT_Monster'"));
}